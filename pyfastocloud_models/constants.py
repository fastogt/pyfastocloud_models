...
MIN_AUDIO_CHANNELS_COUNT = INVALID_AUDIO_CHANNELS_COUNT
MAX_AUDIO_CHANNELS_COUNT = 8

INVALID_FRAME_RATE = 0
MIN_FRAME_RATE = INVALID_FRAME_RATE
MAX_FRAME_RATE = 100
...
MIN_STREAM_GROUP_TITLE_LENGTH = 1
